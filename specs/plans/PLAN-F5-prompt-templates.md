...
```json
// Response 200
{ "templates": [{ "id": "...", "name": "Code Review", "description": "...", "modelHint": "codellama", "variables": ["language", "code"], "createdAt": "...", "updatedAt": "..." }] }
```

**GET /api/templates/:id**
```json
// Response 200
{ "id": "...", "name": "Code Review", "content": "Review this {{language}} code:\n{{code}}", "description": "...", "modelHint": "codellama", "variables": ["language", "code"], "createdAt": "...", "updatedAt": "..." }
```
